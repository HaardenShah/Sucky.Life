...
<style>
  ...
  input[type=password], input[type=text]{width:100%; padding:12px 12px; border-radius:12px; border:1px solid #2a2f42; background:#0b1020; color:#f0f4ff}
  ...
  .muted{color:#9aa2b8; font-size:13px}
  a{color:#cbd5ff}
</style>
</head>
<body>
<div class="wrap">
  ...
  <div class="panel">
    <form method="post" action="update_privacy.php">
      ...
      <div class="muted">Tip: You can share this password with friends. It&rsquo;s stored hashed.</div>
